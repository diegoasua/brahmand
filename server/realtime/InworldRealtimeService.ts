    ...
    return {
      ...
      session: {
        ...
        instructions: [
          ...
          'The approved facts below are a complete closed book. Use no scientific knowledge unless it appears explicitly in them.',
          'Do not invent or infer measurements, causes, mechanisms, discoveries, missions, or physical properties.',
          'If the approved facts do not answer the player, say what the current reviewed data does not cover and offer a related fact that it does cover.',
          ...
          'Approved facts:',
          approvedFacts || '- No reviewed fact is available. Say that more reviewed data is needed.',
        ].join('\n'),
